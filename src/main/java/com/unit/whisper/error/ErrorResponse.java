...
public record ErrorResponse(
        ...
        @Schema(description = "에러 리스트 ex) 필드 에러들") List<Error> result) {

    public static ErrorResponse fromErrorCode(final ErrorCode errorCode) {
        return new ErrorResponse(
                errorCode.getCode(), errorCode.getMessage(), Collections.emptyList());
    }

    public static ErrorResponse ofBindingResult(
            final ErrorCode errorCode, final BindingResult bindingResult) {
        return new ErrorResponse(
                errorCode.getCode(),
    ...
    public static ErrorResponse fromParameter(
            final ErrorCode errorCode, final String parameterName) {
        return new ErrorResponse(
                errorCode.getCode(),
                errorCode.getMessage(),
    ...
    public static ErrorResponse fromType(
            final ErrorCode errorCode, final String parameterName, final String value) {
        return new ErrorResponse(
                errorCode.getCode(),
                errorCode.getMessage(),
    ...
    public record Error(String field, String value, String reason) {
        ...
        public static List<Error> fromBindingResult(final BindingResult bindingResult) {
            return bindingResult.getFieldErrors().stream().map(Error::fromFieldError).toList();
        }
